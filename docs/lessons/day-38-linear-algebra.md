...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_38_Linear_Algebra/solutions.ipynb){ .md-button .md-button--primary }
...
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_38_Linear_Algebra/solutions.ipynb){ .md-button }
