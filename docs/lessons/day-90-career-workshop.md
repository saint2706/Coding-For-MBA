...
*   **SQL Challenges:** You'll be given a schema and asked to write queries to answer business questions. Expect questions involving `JOIN`s, `GROUP BY`, window functions, and subqueries.
