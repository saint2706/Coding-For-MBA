...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_34_Building_an_API/api_server.ipynb){ .md-button .md-button--primary }
...
- **api_server.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_34_Building_an_API/api_server.ipynb){ .md-button }
- **data.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_34_Building_an_API/data.ipynb){ .md-button }
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_34_Building_an_API/solutions.ipynb){ .md-button }
