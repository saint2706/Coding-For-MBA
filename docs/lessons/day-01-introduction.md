...
Before you begin, please follow the setup instructions in the main [README.md](https://github.com/saint2706/Coding-For-MBA/blob/main/README.md) at
the root of this repository. This will guide you through:
...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_01_Introduction/helloworld.ipynb){ .md-button .md-button--primary }
...
- **helloworld.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_01_Introduction/helloworld.ipynb){ .md-button }
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_01_Introduction/solutions.ipynb){ .md-button }
