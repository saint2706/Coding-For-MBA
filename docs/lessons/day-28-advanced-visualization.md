...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_28_Advanced_Visualization/advanced_visualization.ipynb){ .md-button .md-button--primary }
...
- **advanced_visualization.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_28_Advanced_Visualization/advanced_visualization.ipynb){ .md-button }
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_28_Advanced_Visualization/solutions.ipynb){ .md-button }
