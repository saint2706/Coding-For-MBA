...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_41_Supervised_Learning_Regression/solutions.ipynb){ .md-button .md-button--primary }
...
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_41_Supervised_Learning_Regression/solutions.ipynb){ .md-button }
