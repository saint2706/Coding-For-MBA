...
<div id="tagFilters" style="margin-bottom: 20px;">
    ...
    <button class="tag-filter" data-tag="BI" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">BI</button>
    <button class="tag-filter" data-tag="Basics" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Basics</button>
    <button class="tag-filter" data-tag="Data" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Data</button>
    <button class="tag-filter" data-tag="Database" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Database</button>
    <button class="tag-filter" data-tag="ML" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">ML</button>
    <button class="tag-filter" data-tag="MLOps" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">MLOps</button>
    <button class="tag-filter" data-tag="NLP" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">NLP</button>
    <button class="tag-filter" data-tag="Python" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Python</button>
    <button class="tag-filter" data-tag="SQL" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">SQL</button>
    <button class="tag-filter" data-tag="Statistics" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Statistics</button>
    <button class="tag-filter" data-tag="Visualization" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Visualization</button>
    <button class="tag-filter" data-tag="Web" style="margin: 5px; padding: 5px 12px; border: 1px solid #ddd; border-radius: 15px; background: white; color: #333; cursor: pointer;">Web</button>
  </div>
</div>
