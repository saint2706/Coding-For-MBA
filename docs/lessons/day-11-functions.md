...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_11_Functions/functions.ipynb){ .md-button .md-button--primary }
...
- **functions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_11_Functions/functions.ipynb){ .md-button }
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_11_Functions/solutions.ipynb){ .md-button }
