...
1.  **Platform Comparison:** Compare and contrast the features, pricing, and integrations of Power BI, Tableau Online, and Google Data Studio for a fictional e-commerce company.
2.  **Data Warehouse Selection:** Based on the needs of the e-commerce company, recommend a cloud data warehouse (Snowflake, BigQuery, or Redshift) and justify your choice.
3.  **Security Plan:** Outline a security plan for the e-commerce company's cloud BI environment, covering IAM, data encryption, and monitoring.
