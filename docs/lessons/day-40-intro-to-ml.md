...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_40_Intro_to_ML/solutions.ipynb){ .md-button .md-button--primary }
...
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_40_Intro_to_ML/solutions.ipynb){ .md-button }
