...
| File | Description | | --- | --- | | [`case_study.py`](https://github.com/saint2706/Coding-For-MBA/blob/main/Day_36_Case_Study/case_study.py) | Student-facing template
containing callable helpers and a minimal `main()` driver you can customize. | |
...
[🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_36_Case_Study/case_study.ipynb){ .md-button .md-button--primary }
...
- **case_study.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_36_Case_Study/case_study.ipynb){ .md-button }
- **solutions.ipynb**
  ...
  [🪐 Launch in JupyterLite](/jupyterlite/lab?path=Day_36_Case_Study/solutions.ipynb){ .md-button }
