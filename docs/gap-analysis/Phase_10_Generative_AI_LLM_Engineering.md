...
**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_109_LLM_Landscape/README.md`
...
**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_110_Prompt_Engineering_Mastery/README.md`
...
## Day 111 — LangChain & LlamaIndex — Document Loaders, Chains, Memory

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_111_LangChain_and_LlamaIndex/README.md`
...
## Day 112 — RAG Pipelines — Embeddings, Vector Stores, Retrieval

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_112_RAG_Pipelines/README.md`
...
**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_113_Fine_Tuning_LLMs/README.md`
...
## Day 114 — Evaluation & Guardrails — RAGAS, TruLens, Guardrails AI

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_114_Evaluation_and_Guardrails/README.md`
...
## Day 115 — LLM Agents & Tool Use — ReAct, Function Calling, Multi-Agent

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_115_LLM_Agents_and_Tool_Use/README.md`
...
## Day 116 — LLM Ops & Cost Management — Token Optimization, Caching, Tracing

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_116_LLM_Ops_and_Cost_Management/README.md`
...
## Day 117 — Multimodal AI — Vision-Language Models, GPT-4V, Gemini Vision

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_117_Multimodal_AI/README.md`
...
## Day 118 — AI Product Design — Product Thinking for LLM Features

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_118_AI_Product_Design/README.md`
...
## Day 119 — AI Ethics in Practice — Bias Audits, Red-Teaming, Responsible Deployment

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_119_AI_Ethics_in_Practice/README.md`
...
## Day 120 — Capstone: Build an AI-Powered Data Assistant

**Path:** `content/lessons/Phase_10_Generative_AI_LLM_Engineering/Day_120_Capstone_AI_Data_Assistant/README.md`
