...
import { prefetchRoute, createRoutePrefetchHandlers } from '../../../src/utils/prefetchRoutes'
...
vi.mock('../../../src/pages/Home', () => ({ default: mockHome }))
vi.mock('../../../src/pages/Curriculum', () => ({ default: mockCurriculum }))
vi.mock('../../../src/pages/PhaseOverview', () => ({ default: mockPhaseOverview }))
vi.mock('../../../src/pages/Lesson', () => ({ default: mockLesson }))
vi.mock('../../../src/pages/ProgressDashboard', () => ({ default: mockProgressDashboard }))
vi.mock('../../../src/pages/Exercises', () => ({ default: mockExercises }))
vi.mock('../../../src/pages/NotebookViewer', () => ({ default: mockNotebookViewer }))
vi.mock('../../../src/pages/SearchResults', () => ({ default: mockSearchResults }))
vi.mock('../../../src/pages/ConceptGraphPage', () => ({ default: mockConceptGraphPage }))
vi.mock('../../../src/pages/ContentStats', () => ({ default: mockContentStats }))
vi.mock('../../../src/pages/Review', () => ({ default: mockReview }))
