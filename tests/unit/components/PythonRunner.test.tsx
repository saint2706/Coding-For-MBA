...
import PythonRunner, { PythonRunnerHandle } from '../../../src/components/PythonRunner'
import * as usePyodideHook from '../../../src/hooks/usePyodide'
import * as codeSecurity from '../../../src/utils/codeSecurity'

vi.mock('../../../src/hooks/usePyodide', () => ({
  usePyodide: vi.fn(),
}))

vi.mock('../../../src/utils/codeSecurity', () => ({
