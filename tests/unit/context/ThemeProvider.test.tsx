...
import * as userPreferencesStore from '../../../src/stores/userPreferencesStore'
import { ThemeContext } from '../../../src/context/ThemeContext'

// Mock the user preferences store
vi.mock('../../../src/stores/userPreferencesStore', async () => {
  const actual = await vi.importActual('../../../src/stores/userPreferencesStore')
  return {
    ...actual,
