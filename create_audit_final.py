...
out_lines.append("\n## Phase summary")
out_lines.append("Phase 09 covers critical enterprise SQL performance concepts. The material often lacks strong business/MBA framing and real-world analogy sections. Lab exercises consistently omit clear expected results sets and sample schemas. Furthermore, comparison tables often lack decision guidance (e.g., 'When to use'). Many lessons lack an explicit 'Tomorrow' preview, Pitfalls callouts, and explanations in quiz files.")
out_lines.append("\n**Recurring gaps in this phase:**")
out_lines.append("- [P0] Widespread lack of Business/MBA framing linking SQL concepts to executive decision making.")
out_lines.append("- [P1] Lab exercises frequently omit expected results and specific sample schema data.")
out_lines.append("- [P1] Tables lack DECISION GUIDANCE columns.")
out_lines.append("- [P2] Missing Glossary sections, Pitfalls, and 'Tomorrow' previews across most lessons.")
