        ...
        <div className="page-container">
            ...
            <div className="lesson-header">
                ...
                <div className="lesson-meta-bar">
                    ...
                    {lesson.duration && (
                        <span className="meta-pill">⏱ {lesson.duration} min</span>
                    )}
                    {lesson.tags && lesson.tags.map(tag => (
                        <span className="lesson-tag" key={tag}>{tag}</span>
                    ))}
                </div>
            </div>
            ...
            <nav className="lesson-nav">
                {prev && (
                    <Link to={`/lesson/${prev.day}`} className="lesson-nav-btn prev">
                        ...
                        <span className="lesson-nav-title">Day {prev.day}: {prev.title}</span>
                    </Link>
                )}
                {next && (
                    <Link to={`/lesson/${next.day}`} className="lesson-nav-btn next">
                        <span className="lesson-nav-label">Next →</span>
                        <span className="lesson-nav-title">Day {next.day}: {next.title}</span>
                    </Link>
                )}
            </nav>
        </div>
