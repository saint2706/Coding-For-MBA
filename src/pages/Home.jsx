...
import { getAllPhases, getLessonsByPhase, difficultyConfig, phaseIcons } from '../utils/contentLoader'
        ...
        <div className="page-container">
            ...
            <section className="hero">
                ...
                <h1>
                    ...
                    <br />for Your MBA Career
                </h1>
                <p>
                    A structured 108-day curriculum covering Python, Data Science, Machine Learning,
                    Business Intelligence, and Enterprise SQL — designed for business professionals.
                </p>
            ...
            <section>
                <div className="section-header">
                    ...
                    <p>From Python basics to enterprise database architecture — a structured journey through 9 phases.</p>
                </div>
