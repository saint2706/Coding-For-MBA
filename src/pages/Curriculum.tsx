...
export default function Curriculum() {
  ...
  const itemListSchema = buildItemListSchema(
    ...
    `Browse the complete ${totalLessons}-day curriculum roadmap across ${phases.length} phases — from Python foundations to enterprise SQL.`,
  ...
  return (
    <div className="page-container">
      <SEOHead
        ...
        description={`Browse the complete ${totalLessons}-day curriculum roadmap across ${phases.length} phases — from Python foundations to enterprise SQL.`}
        path="/curriculum"
        breadcrumbs={[
          { name: 'Home', url: '/' },
        ...
        jsonLd={[
          ...
          buildProductSchema(
            'Coding for MBA',
            `A structured ${totalLessons}-day curriculum covering Python, Data Science, Machine Learning, Business Intelligence, and Enterprise SQL — designed for MBA professionals.`,
          ),
        ]}
      />
