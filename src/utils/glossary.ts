...
export const glossaryTerms: Record<string, string> = {
    ...
    'list comprehension': 'A concise way to create lists using a single line of code with an embedded loop.',
    ...
    'exploratory data analysis': 'Summarizing and visualizing data to discover patterns before modeling.',
    ...
    'gradient descent': 'An optimization algorithm that iteratively adjusts parameters to minimize error.',
    ...
    'p-value': 'The probability that observed results occurred by chance; low values suggest significance.',
    'hypothesis testing': 'A statistical method for deciding whether data supports a specific claim.',
    'confidence interval': 'A range of values within which the true population parameter likely falls.',
}
