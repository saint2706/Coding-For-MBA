 ...
 *
 * @param {string} value - The input markdown string.
 * @returns {string} The plain text string without formatting.
 */
 ...
 * @returns {string} The concatenated plain text string.
 */
 ...
 *
 * @returns {{slug: (value: string) => string}} An object with a `slug` method.
 */
