 ...
 */
const EditorialLessonHeader = forwardRef<HTMLElement, EditorialLessonHeaderProps>(
  function EditorialLessonHeader(
    {
      day,
      title,
      phaseNum,
    ...
    return (
      <header className="lesson-masthead" ref={ref}>
...
export default EditorialLessonHeader
