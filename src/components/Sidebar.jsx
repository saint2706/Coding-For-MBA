...
export default function Sidebar({ isOpen, onClose }) {
    ...
    const openPhase = manualOpen !== undefined && manualOpen !== null
        ? manualOpen
        : derivedOpenPhase
    ...
    const prevPath = useMemo(() => location.pathname, [location.pathname])
    if (manualOpen !== null && prevPath === location.pathname) {
        // keep manual
    }
