  ...
  describe('propsAreEqual optimization', () => {
    ...
    it('handles currentPath changes correctly', () => {
      ...
      vi.mocked(contentLoader.getLesson).mockImplementation((day: string | number) => {
        if (day === '01') return { phase: 1 } as unknown as ReturnType<typeof contentLoader.getLesson>
        if (day === '03') return { phase: 2 } as unknown as ReturnType<typeof contentLoader.getLesson>
        return undefined
      })
