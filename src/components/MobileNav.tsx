...
export default function MobileNav() {
    ...
    return (
        <nav className="mobile-nav" aria-label="Mobile navigation">
            ...
            <NavLink to="/curriculum" className={({ isActive }) => `mobile-nav-item ${isActive ? 'active' : ''}`}>
            ...
            <NavLink to="/concepts" className={({ isActive }) => `mobile-nav-item ${isActive || isLesson ? 'active' : ''}`}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3" /><path d="M12 2v4m0 12v4m-7.07-2.93l2.83-2.83m8.48-8.48l2.83-2.83M2 12h4m12 0h4m-2.93 7.07l-2.83-2.83M6.76 6.76L3.93 3.93" /></svg>
                <span>Explore</span>
            </NavLink>
        </nav>
    )
