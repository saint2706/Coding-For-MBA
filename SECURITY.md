...
- **Automated Scanning**: This project uses [GitHub Dependency Review](https://docs.github.com/en/code-security/concepts/supply-chain-security/about-dependency-review) to block pull requests that introduce high or critical vulnerabilities.
...
- [npm Security Documentation](https://docs.npmjs.com/policies/security/)
