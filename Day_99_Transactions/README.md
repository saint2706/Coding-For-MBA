...
Welcome to Day 99! Today, we'll learn about **Transactions**, a sequence of operations performed as a single logical unit of work.

## What is a Transaction?

A transaction is a unit of work that is performed against a database. Transactions are used to ensure data integrity. All the statements in a transaction are executed as a single unit. If any statement in the transaction fails, the entire transaction is rolled back, and the database is left in its original state.
