...
DML commands are used to insert, update, and delete data in a database. Unlike DDL commands, which
work on the structure of the database, DML commands work on the data itself.
