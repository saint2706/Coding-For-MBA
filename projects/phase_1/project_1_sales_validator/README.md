...
2. **Product codes**: Must match pattern (e.g., PRD-XXXX where X is digit)
3. **Quantities**: Must be positive integers
4. **Prices**: Must be positive numbers with max 2 decimal places
5. **Customer IDs**: Must be 6-digit numbers
6. **Regions**: Must be one of: North, South, East, West
